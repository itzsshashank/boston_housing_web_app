...
boston = pd.read_csv('C:/Users/shash/Desktop/NEW BAI/Machine-Learning-Projects/05.Boston_House_Price_Prediction/data/housing.csv', delimiter=r"\s+", names=columns)
...
pickle.dump(random_forest_regressor, open("C:\\Users\\shash\\Desktop\\NEW BAI\\Machine-Learning-Projects\\models\\boston_house_price_predictor.pkl", "wb"))
